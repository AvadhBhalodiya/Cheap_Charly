...
import 'package:e_commerce_app/screens/signup/signup_screen.dart';
import 'package:e_commerce_app/stylies/login_screen_stylies.dart';
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          Text("Forgot password?", style: LoginScreenStylies.forgotPasswordStylies,
          ),
      ],
    );
  }
